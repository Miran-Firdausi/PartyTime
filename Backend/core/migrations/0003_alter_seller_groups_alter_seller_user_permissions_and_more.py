# Generated by Django 5.0.1 on 2024-04-09 18:02
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('core', '0002_alter_seller_managers'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='seller',
            name='groups',
            field=models.ManyToManyField(blank=True, help_text='The groups this user belongs to.', related_name='seller_groups', related_query_name='user', to='auth.group', verbose_name='groups'),
        ),
        migrations.AlterField(
            model_name='seller',
            name='user_permissions',
            field=models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='seller_permissions', related_query_name='user', to='auth.permission', verbose_name='user permissions'),
        ),
